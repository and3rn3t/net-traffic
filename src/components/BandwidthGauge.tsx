...
export function BandwidthGauge({ currentBytes, maxBytes, label = 'Current Throughput' }: BandwidthGaugeProps) {
  ...
  useEffect(() => {
    ...
    ctx.fillText(`${(percentage * 100).toFixed(1)}% of ${formatBytesShort(maxBytes)}`, centerX, centerY + 20)
